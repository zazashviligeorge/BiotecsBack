...
namespace BiotecsBack.Services.FileHandling
{
    public class FileHandler : PhysicalFileProvider, IFileHandler
    {
        ...
        public virtual string GetRandomFileName(string fileName)
        {
